Pego de Rocketseat **[Desafio07](https://github.com/Rocketseat/bootcamp-gostack-desafios/blob/master/desafio-fundamentos-reactjs/README.md)**
...
- Rodar o **[Backend](https://github.com/rafael399/gostack-desafio06)** da aplicação
- Caso queira rodar a aplicação execute o comando `yarn start` na pasta da da aplicação
- Caso queira rodar apenas os testes automatizados, execute o comando `yarn test`
